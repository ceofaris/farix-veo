...
import { LayoutDashboard, Wrench, UserCog, FlaskConical, Sparkles, Newspaper, ShieldAlert, Settings, Puzzle } from "lucide-react";
  ...
  return (
    <PanelLayout
      ...
      items={[
        ...
        { to: "/king/suspended", label: "Suspended", icon: ShieldAlert },
